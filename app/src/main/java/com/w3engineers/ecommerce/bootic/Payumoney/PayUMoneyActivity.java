package com.w3engineers.ecommerce.bootic.Payumoney;
...
import com.w3engineers.ecommerce.bootic.checkoutPayment.ConfirmActivity;
...
public class PayUMoneyActivity extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "w1BCokMJ";
    private String mSalt = "qjXAart9B8";
    ...
    private String mSuccessUrl = Constants.SUCCESS_PATH;
    private String mFailedUrl = Constants.FAILURE_PATH;

    String responsed_order_id;
...
//        ab.setTitle("payment");
        ...
        if (bundle != null) {
            ...
            Log.i("firsttag", "" + mFirstName + " : " + mEmailId + " : " + mAmount + " : " + mPhone);
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                   final DataSource dataSource = new DataSource(PayUMoneyActivity.this);
                    if (url.equals(mSuccessUrl)) {

//                        Log.v("adsasdasdsad","this is success");
...
//                            RequestQueue queue = Volley.newRequestQueue(PayUMoneyActivity.this);
//                            StringRequest stringRequest = new StringRequest(Request.Method.POST, JSON_URL, new Response.Listener<String>() {
//                                @Override
//                                public void onResponse(String response) {
//                                    responsed_order_id = response.toString().trim();
...
//                        }
    ...
    private void onPressingBack() {
        ...
        if(isFromOrder)
            intent = new Intent(PayUMoneyActivity.this, CartActivity.class);
        else
